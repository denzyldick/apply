                ...
                <div class="col-md-9 col-md-offset-3">
                    ...
                    <div class="btn-group btn-next" data-toggle="buttons">
                        <label class="btn btn-lg btn-primary">
                            <input type="radio" name="type" value='employer'>{{ lang._("searching_for_employees")|upper }}
                        </label>
...
height: 400px;
margin-bottom: 20px;
overflow-y: scroll;"><div class="container terms">
                        <h2><i class="icon-book-open"></i> Terms and conditions</h2>
                        <ol>
                            <li>
                                <p><strong>Preamble:</strong> This Agreement, signed on Nov 15, 2014 [hereinafter: Effective Date] governs the relationship between Helene, a duly registered company, (hereinafter: Licensee) and Helene, a duly registered company in Netherlands whose principal place of business is Netherlands (Hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using [Helene] (hereinafter: The Software) created and owned by Licensor, as detailed herein</p>
                            </li><li>
                            ...
                            <li>
                                <p><strong>No Refunds:</strong> Licensee warrants that he inspected The Software according to clause 8.3 and that it is adequate to his needs. Accordingly, as The Software is   intangible goods, Licensee shall not be, ever, entitled to any refund,   rebate, compensation or restitution for any reason whatsoever, even if   The Software contains material flaws.</p>
                            </li>
                            <li>
                ...
                <button class="btn btn-primary btn-lg" data-toggle="button">I accept the licence agreements!</button>
                <p></p>
