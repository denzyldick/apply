<h3>{{lang._('market_place')}}</h3>
<small>{{ lang._("need_additional_features") }}</small>
<div class="row"><div class='col-md-3'  style='text-align:center;margin:10px'>
    ...
    <div class="col-md-6">
        ...
        <form action="/premium/charge" method="post">
            ...
            <div class="col-md-3"><input type="text" value=1 name="amount" placeholder="{{ lang._("amount_needed") }}" class="form-control"></div>
            <div class="col-md-3"><a href="" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-shopping-cart"></span> {{ lang._("by_now") }}</a></div>
            <div class="row">
                <p>&nbsp;&nbsp;</p>
