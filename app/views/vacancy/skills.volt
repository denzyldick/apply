...
border-bottom: 1px solid #D8D7D6;">
        ...
        <div class="col-md-5"><input type="text" class="slider" id="{{ skills }}" value="0" data-slider-min="0" data-slider-max="50" data-slider-step="1" data-slider-value="0" data-slider-orientation="horizontal" data-slider-selection="after" data-slider-tooltip="hide" name="{{ skills|e }}">
        </div>
